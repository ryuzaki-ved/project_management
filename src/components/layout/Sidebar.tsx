...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className={`transition-all duration-300 bg-white border-r border-gray-200 h-screen flex flex-col ${collapsed ? 'w-20' : 'w-64'}`}>
      <div className="p-2 flex items-center justify-between border-b border-gray-200">
        ...
        <button onClick={() => setCollapsed(c => !c)} className="p-2 rounded hover:bg-gray-100 transition-colors">
