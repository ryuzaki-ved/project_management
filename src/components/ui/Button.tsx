...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700 focus:ring-gray-500 border border-gray-300 dark:border-gray-700',
  ...
  return (
    ...
    >
      ...
      {Icon && !loading && <Icon size={size === 'lg' ? 20 : 16} />}
      {children}
    </button>
  );
};